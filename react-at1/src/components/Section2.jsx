      ...
      <>
        <div className="card-container">
          <div className="card" style={{ backgroundColor: '#F1C2B0' }}>
            <div className="card-header" style={{ backgroundColor: '#F1C2B0', color: '#ffffff' }}>01
          ...
          <div className="card" style={{ backgroundColor: '#F9EB98' }}>
            <div className="card-header" style={{ backgroundColor: '#F9EB98', color: '#ffffff' }}>02
          ...
          <div className="card" style={{ backgroundColor: '#C0D9DD' }}>
            <div className="card-header" style={{ backgroundColor: '#C0D9DD', color: '#ffffff' }}>03
          ...
          <div className="card" style={{ backgroundColor: '#6975E8' }}>
            <div className="card-header" style={{ backgroundColor: '#6975E8', color: '#ffffff' }}>04
            <img className="card-image" src="../instagram.png" alt="Instagram" />
            </div>
